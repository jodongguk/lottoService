...
public class Draw {
    ...
    private String drawDateYn;          // Y : 추첨날짜와 yyyyMMdd 파라미터로 전달된 값이 같을경우, N : drawNo 파라미터가 전달되었거나 추첨날짜와 yyyyMMdd 파라미터로 전달된 값이 다를경우
    ...
    public Draw(Long drawNo, String drawDate, String drawDateYn, int num1, int num2, int num3, int num4, int num5, int num6, int bonusNum, Long totalSellingPrice, List<LottoResult> lottoResult, List<WinningPlace> winningPlace) {
        this.drawNo = drawNo;
